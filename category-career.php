        ...
        <div class="p-business__sec01--box01 type-04">
          <div>
            <p class="c-text__intro01">
              <?php echo $lang === "en" ? $sec1Intro['en'] : $sec1Intro['vn']; ?>
            </p>
            <h2 class="c-title__02 type-03">
              <span class="c-title__02--first">
                <?php echo $lang === "en" ? $sec1TitleFirst['en'] : $sec1TitleFirst['vn']; ?>
              </span>
              <span class="c-title__02--last">
                <?php echo $lang === "en" ? $sec1TitleLast['en'] : $sec1TitleLast['vn']; ?>
              </span>
            </h2>
          </div>
          <div>
            <div class="c-text03">
              <?php echo nl2br(esc_html($lang === "en" ? $sec1Desc['en'] : $sec1Desc['vn'])); ?>
            </div>
          </div>
        </div>
        <?php
                  ...
                  <div class="swiper-slide">
                    <div class="sec01__card"
                      ...
                      <div class="sec01__title">
                        <?php echo nl2br(esc_html($lang === "en" ? $item['title']['en'] : $item['title']['vn'])); ?>
                      </div>
                      <div class="sec01__contents">
                        <?php echo nl2br(esc_html($lang === "en" ? $item['contents']['en'] : $item['contents']['vn'])); ?>
                      </div>
                    </div>
                  </div>
                <?php endforeach; ?>
  ...
  <section class="p-archive__sec02">
    <div class="l-container">
      ...
      <div class="p-archive__sec02--group01">
        ...
        <p class="c-text__intro01">
          <?php echo $lang === "en" ? $sec2Intro['en'] : $sec2Intro['vn']; ?>
        </p>
        <h2 class="c-title__02 type-03">
          <span class="c-title__02--last">
            <?php echo $lang === "en" ? $sec2TitleFirst['en'] : $sec2TitleFirst['vn']; ?>
          </span>
          <span class="c-title__02--first">
            <?php echo $lang === "en" ? $sec2TitleLast['en'] : $sec2TitleLast['vn']; ?>
          </span>
        </h2>
      </div>
